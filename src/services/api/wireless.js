...
import { wlanBasicMockData, wlanAdvancedMockData, getWlanWpsMock, updateWlanWpsMock, wlanMeshMockData } from '../mockData/wirelessMockData';
const API_URL = '/API/info';
const isDevelopment = import.meta.env.DEV;
export async function getWlanBasic() {
    if (isDevelopment) {
...
export async function updateWlanBasic(data) {
    if (isDevelopment) {
        return wlanBasicMockData;
    }
    const response = await fetch(`${API_URL}?list=WlanBasic`, {
...
export async function getWlanAdvanced() {
    ...
    return callApi(`${API_URL}?list=WlanAdvanced`);
}
export async function updateWlanAdvanced(data) {
    if (isDevelopment) {
...
export async function getWlanWps() {
    if (isDevelopment) {
        return getWlanWpsMock();
    }
    return callApi(`${API_URL}?list=WlanWps`);
}
export async function updateWlanWps(data) {
    if (isDevelopment) {
...
export async function getWlanMesh() {
    if (isDevelopment) {
        return wlanMeshMockData;
    }
    return callApi(`${API_URL}?list=WlanMesh`);
}
export async function updateWlanMesh(data) {
    if (isDevelopment) {
        return wlanMeshMockData;
    }
