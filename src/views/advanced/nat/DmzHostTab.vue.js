...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    'data-testid': (__VLS_ctx.qa('dmz-tab-content')),
});
if (__VLS_ctx.loading && !__VLS_ctx.dmzData) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({
        type: "checkbox",
        'data-testid': (__VLS_ctx.qa('dmz-enable-checkbox')),
    });
    ...
    if (__VLS_ctx.dmzData.AdvancedDmz.Enable) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)({
            'data-testid': (__VLS_ctx.qa('dmz-ip-label')),
        });
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)({
            ...
            'data-testid': (__VLS_ctx.qa('dmz-ip-input')),
        });
    }
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "button-group" },
