 ...
 * Note: Updated TR-471 keys to use non-prefixed flat keys under the tr471 namespace.
 */
const translations = {
    menu: {
        status: 'Status',
    ...
    // Diagnostics section core labels
    diagnostics: {
    ...
    // Updated TR-471 translations (flattened keys without 'tr471_' prefixes)
    tr471: {
